...
class TransformerTrippleDecoder(nn.Module):
    ...
    def forward(self, tgt, memory, memory2,
                tgt_mask: Optional[Tensor] = None,
                memory_mask: Optional[Tensor] = None,
                tgt_key_padding_mask: Optional[Tensor] = None,
                memory_key_padding_mask: Optional[Tensor] = None,
        ...
        for n,layer in enumerate(self.layers):
            ...
            residual=True
            output,ws = layer(output, memory, memory2, tgt_mask=tgt_mask,
                           memory_mask=memory_mask,
                           tgt_key_padding_mask=tgt_key_padding_mask,
                           memory_key_padding_mask=memory_key_padding_mask,
                           pos=pos, query_pos=query_pos,residual=residual)
...
class TransformerTrippleDecoderLayer(nn.Module):
    ...
    def forward_post(self, tgt, memory, memory2, 
                     tgt_mask: Optional[Tensor] = None,
                     memory_mask: Optional[Tensor] = None,
                     tgt_key_padding_mask: Optional[Tensor] = None,
                     memory_key_padding_mask: Optional[Tensor] = None,
    ...
    def forward_pre(self, tgt, memory, memory2,
                    tgt_mask: Optional[Tensor] = None,
                    memory_mask: Optional[Tensor] = None,
                    tgt_key_padding_mask: Optional[Tensor] = None,
                    memory_key_padding_mask: Optional[Tensor] = None,
    ...
    def forward(self, tgt, memory, memory2,
                ...
                residual=True):
        if self.normalize_before:
            return self.forward_pre(tgt, memory, memory2, tgt_mask, memory_mask,
                                    tgt_key_padding_mask, memory_key_padding_mask, pos, query_pos)
        return self.forward_post(tgt, memory, memory2, tgt_mask, memory_mask,
                                 tgt_key_padding_mask, memory_key_padding_mask, pos, query_pos,residual)
...
net = TransformerDecoderLayer(768, 4)
